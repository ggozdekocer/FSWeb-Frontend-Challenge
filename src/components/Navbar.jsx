  ...
  return (
    <nav className="max-w-7xl mx-auto px-10 py-6 flex flex-col gap-6">
      ...
      <div className="flex justify-between items-center">
        <div className="rotate-45 w-18 h-18 text-[#7B61FF] dark:text-[#8F88FF] font-semibold text-4xl rounded-full bg-[#EEEBFF] dark:bg-[#383344] flex items-center justify-center">
          A
        </div>
        <div className="flex justify-between items-center gap-15">
          ...
          className="border border-indigo-600 px-4 py-2 rounded-md text-indigo-600 dark:text-[#8F88FF] dark:border-[#8F88FF] hover:bg-indigo-50 dark:hover:bg-gray-800 transition">
            {nav.hireMe}
          </button>
        </div>
      </div>
